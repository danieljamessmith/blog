...
This site is made using Quarto, an open source technical publishing system that provides the functionality to render .ipynb files as blog posts, and hosted with GitHub pages.
